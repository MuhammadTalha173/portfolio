        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                <div class="text-center mb-5 wow fadeInUp" data-wow-delay=".3s">
                    <h5 class="mb-2 px-3 py-1 text-light rounded-pill d-inline-block border border-2 border-primary">Get In Touch</h5>
                    <h1 class="display-5 w-50 mx-auto text-light">Fill The Form Below</h1>
                </div>
                <div class="row g-5 mb-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <div class="rounded contact-form">
                            ...
                            <div class="mb-4">
                                <input type="text" class="form-control p-3" placeholder="Phone">
                            </div>
                            <div class="mb-4">
                                <input type="text" class="form-control p-3" placeholder="Phone">
                            </div>
                            <!-- <div class="mb-4">
                                <select type="text" class="form-control p-3 text-dark" placeholder="Please Select Our Services">
                                <option value="logo Desgin"></option>
                                <option value="Graphics Desgin"></option>
                    ...
                    <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="d-flex bg-light p-3 rounded contact-btn-link">
                            ...
                            <div class="ms-3 contact-link">
                                ...
                                <a class="h5 text-dark fs-6" href="#">info@cloudsphere.com</a>
                            </div>
                        </div>
                    </div>
                </div>
